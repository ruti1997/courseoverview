<?php
//יצרתי את התוסף כפלאגין, למפרע התברר שזו אינה הצורה הנכונה לבצע את הדרישה
// לא ניתן לבצע קבלת פרמטר בדפדוף העמודים בפלאגין, התיקון הנדרש שינוי סוג התוסף (ככל הנראה לבלוק)
// בעקבות שהגיע מועד הגשה המשימה לא הספקתי לסיים כראוי
